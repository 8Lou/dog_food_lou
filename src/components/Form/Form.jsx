//ВАРИАНТ НАПИСАНИЯ ФОРМЫ БЕЗ БИБЛИОТЕК
...
export const Form = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault(); //при онклике предотвартить перезагрузку
    // e.stopPropagation();
    sendData({
      ...contactInfo,
...
//С ПОМОЩЬЮ value КОНТРОЛИРУЕТСЯ СОСТОЯНИЕ input, У КОТОРОГО В РЕАКТЕ СВОЕ ПОВЕДЕНИЕ
